...
class BISRetriever:
    ...
    def retrieve(self, query: str, top_k: int = 5) -> List[Dict[str, Any]]:
        ...
        for score, idx in zip(scores[0], indices[0]):
            ...
            # Build the result dict explicitly (rather than dumping every
            # field) so the output shape is exactly what's needed downstream:
            # similarity score + the four traceability fields + the text.
            results.append({
